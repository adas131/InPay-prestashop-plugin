...
class Inpay extends PaymentModule
{
    ...
    {
        $this->_html .= '<img src="../modules/inpay/logo.png" style="float:left; margin-right:15px;"><b>' . 'This module allows you to accept Bitcoin payments by InPay.<br/>If you require any help contact info@inpay.pl' . '</b><br /><br />';
    }
        ...
        $this->_html .=
			...
			<legend>' . $this->l('Merchant configuration') . '</legend>
				...
				<table border="0" width="500" cellpadding="0" cellspacing="0" id="form">
                    ...
                    <tr><td>' . $this->l('Use Testnet') . '</td><td>
